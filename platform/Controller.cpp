...
game_option controller_options[] =
{
    ...
    { "touch_y_x", &tmp_skin.y_x },
    { "touch_y_y", &tmp_skin.y_y },
    { "touch_y_radius", &tmp_skin.y_radius },
    { "touch_x_x", &tmp_skin.x_x },
    { "touch_x_y", &tmp_skin.x_y },
    { "touch_x_radius", &tmp_skin.x_radius },
